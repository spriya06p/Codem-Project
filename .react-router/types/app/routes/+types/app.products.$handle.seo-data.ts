...
type Module = typeof import("../app.products.$handle.seo-data.js")

type Info = GetInfo<{
  file: "routes/app.products.$handle.seo-data.jsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.products.$handle.seo-data.js");
}];
