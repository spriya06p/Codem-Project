...
type Pages = {
  ...
  "/app/products/:handle/seo-data": {
    params: {
      "handle": string;
    };
  };
  "/app/products/:handle/edit": {
    params: {
      "handle": string;
    };
  };
...
type RouteFiles = {
  "root.jsx": {
    id: "root";
    page: "/" | "/webhooks/app/scopes_update" | "/webhooks/app/uninstalled" | "/auth/login" | "/auth/*" | "/app" | "/app/products/:handle/seo-data" | "/app/products/:handle/edit" | "/app/additional";
  };
  ...
  "routes/app.jsx": {
    id: "routes/app";
    page: "/app" | "/app/products/:handle/seo-data" | "/app/products/:handle/edit" | "/app/additional";
  };
  "routes/app.products.$handle.seo-data.jsx": {
    id: "routes/app.products.$handle.seo-data";
    page: "/app/products/:handle/seo-data";
  };
  "routes/app.products.$handle.edit.jsx": {
    id: "routes/app.products.$handle.edit";
    page: "/app/products/:handle/edit";
  };
...
type RouteModules = {
  ...
  "routes/app.products.$handle.seo-data": typeof import("./app/routes/app.products.$handle.seo-data.jsx");
  "routes/app.products.$handle.edit": typeof import("./app/routes/app.products.$handle.edit.jsx");
